...
\end{itemize}
%\item[\Smiley]{Don't know $\P(\texttt{catch})$ exactly but can estimate w/ tracking data}
\end{itemize}
...
\visible<3->{
\item{\href{https://www.tandfonline.com/doi/full/10.1080/01621459.2016.1264957}{Linero (2016)} modifies BART so that}
\begin{itemize}
...
\item{Avoids detailed pre-specification of functional form of $f(\bx) = \E[Y \mid X = \bx]$}
...
\makebox[0.95\paperwidth]{
Package: \url{https://github.com/skdeshpande91/flexBART} \hfill
}
\makebox[0.95\paperwidth]{
Website: \url{https://skdeshpande91.github.io} \hfill
}
\makebox[0.95\paperwidth]{
Preprint: \href{https://arxiv.org/abs/2211.04459}{[arXiv:2211.04456]} \hfill
}
}
\end{frame}
